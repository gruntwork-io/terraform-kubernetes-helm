...
output "tiller_ca_tls_certificate_key_pair_secret_namespace" {
  ...
  value = "${
    var.tiller_tls_gen_method == "provider"
    ? module.tiller_tls_certs.ca_tls_certificate_key_pair_secret_namespace
    : var.tiller_tls_gen_method == "kubergrunt"
...
output "tiller_ca_tls_certificate_key_pair_secret_name" {
  ...
  value = "${
    var.tiller_tls_gen_method == "provider"
    ? module.tiller_tls_certs.ca_tls_certificate_key_pair_secret_name
    : var.tiller_tls_gen_method == "kubergrunt"
      ? local.tiller_tls_ca_certs_secret_name 
      : ""
  }"
...
output "tiller_tls_certificate_key_pair_secret_namespace" {
  ...
  value = "${
    var.tiller_tls_gen_method == "provider"
    ? module.tiller_tls_certs.signed_tls_certificate_key_pair_secret_namespace
    : var.tiller_tls_gen_method == "kubergrunt"
      ? var.namespace
      : ""
  }"
...
output "tiller_tls_certificate_key_pair_secret_name" {
  ...
  value = "${
    var.tiller_tls_gen_method == "provider"
    ? module.tiller_tls_certs.signed_tls_certificate_key_pair_secret_name
    : var.tiller_tls_gen_method == "kubergrunt"
