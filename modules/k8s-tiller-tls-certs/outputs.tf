output "ca_tls_certificate_key_pair_secret_namespace" {
  ...
  value       = "${kubernetes_secret.ca_secret.metadata.0.namespace}"
}
...
output "ca_tls_certificate_key_pair_secret_name" {
  ...
  value       = "${kubernetes_secret.ca_secret.metadata.0.name}"
}
...
output "signed_tls_certificate_key_pair_secret_namespace" {
  ...
  value       = "${kubernetes_secret.signed_tls.metadata.0.namespace}"
}
...
output "signed_tls_certificate_key_pair_secret_name" {
  ...
  value       = "${kubernetes_secret.signed_tls.metadata.0.name}"
}
